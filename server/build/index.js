...
var createPool_1 = require("./utils/createPool");
...
*/
app.get("/boards", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var conn, queryResults, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                conn = _a.sent();
                return [4 /*yield*/, conn.query("SELECT * FROM boards;")];
            case 2:
...
app.delete("/boards", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var conn, queryResults, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
